...
public:
	...
	// Sends two bytes <Data0:1> to <DEVICE_ADDR> on the register <Reg_ADDR>
	void Send_I2C_2Bytes(unsigned char DEVICE_ADDR, unsigned char Reg_ADDR, unsigned char Data0, unsigned char Data1);	
